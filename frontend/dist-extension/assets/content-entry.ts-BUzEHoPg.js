(function(){var e=class{lastTrigger=0;onKeydown(e,t){let n=Date.now();if(n-this.lastTrigger<200)return;let r=e.target,i=r.value||r.innerText||``;e.key===`Enter`&&t&&(this.lastTrigger=n,t(i))}},t=`ai-suggestions-overlay`,n=null;function r(e){i(),a(),n=document.createElement(`div`),n.id=t,n.className=`ai-overlay`;let r=`
